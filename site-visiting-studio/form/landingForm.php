...
<html>
	...
	<body>
		<?php
			...
			echo "<div><h1>Спасибо за заказ 'Landing'.</h1>";
			echo "<p>Контактное лицо: ".$name."</p>";
			echo "<p>Номер телефона: ".$phone."</p>";
			echo "<p>Срок создания сайта: 10 - 15 дней: ".$services_1."</p>";
			echo "<p>Уникальный и запоминающийся дизайн сайта: " .$services_2."</p>";
			...
			echo "<p>CMS система управления сайтом: " .$services_6."</p>";
			echo "<p>Виджеты социальных сетей: " .$services_7."</p>";
			echo "<p>Кроссбраузерность в: Mozilla Firefox, Safari, Google Chrome, Opera, IE: " .$services_8."</p>";
			echo "<p>Копирайтинг: " .$services_9."</p>";
			echo "<p>Модули 'Форма обратной связи': " .$services_10."</p>";
			echo "<p>Настройка системы Яндекс.Метрика и Google Analytics для сайта: " .$services_11."</p>";
			echo "<p>Настройка скриптов и анимации: " .$services_12."</p>";
			echo "<p>Счетчик посещаемости сайта: " .$services_13."</p>";
			echo "<p>Регистрация в поисковых системах: " .$services_14."</p>";
			echo "<p>Модуль 'Фотогалерея' + настройка анимации: " .$services_15."</p>";
			...
			echo "<p>Мобильная версия (20 000 руб.): " .$services_42."</p>";
			echo "<p>Создание групп в социальной сети (4 500 руб.): " .$services_43."</p>";
			echo "<p>Google Analytics (3 500 руб.): " .$services_44."</p>";
			echo "<p>Google AdWords (5 000 руб.): ".$services_45."</p></div>";
		?>
	</body>
</html>