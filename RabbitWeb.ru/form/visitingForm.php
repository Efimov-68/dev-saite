...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="../css/import_style.css" content="width=device-width">
	...
	<body>
		<?php
			...
			$services_11 = $_GET['order11'];
			$services_12 = $_GET['order12'];
			$services_13 = $_GET['order13'];
			$services_14 = $_GET['order14'];
			$services_15 = $_GET['order15'];
			$services_16 = $_GET['order16'];
			$services_17 = $_GET['order17'];
			$services_18 = $_GET['order18'];
			$services_19 = $_GET['order19'];
			$services_20 = $_GET['order20'];
			$services_21 = $_GET['order21'];
			$services_22 = $_GET['order22'];
			$services_23 = $_GET['order23'];
			$services_24 = $_GET['order24'];
			$services_25 = $_GET['order25'];
			$services_26 = $_GET['order26'];
			$services_27 = $_GET['order27'];
			$services_28 = $_GET['order28'];
			$services_29 = $_GET['order29'];
			$services_30 = $_GET['order30'];
			$services_31 = $_GET['order31'];
			$services_32 = $_GET['order32'];
			$services_33 = $_GET['order33'];
			$services_34 = $_GET['order34'];
			$services_35 = $_GET['order35'];
			$services_36 = $_GET['order36'];
			$services_37 = $_GET['order37'];

			$to = 'office@rabbitweb.ru';
			$subject = 'Сообщение с сайта "Сайт-визитка"';
			$msg = "Ф.И.О.: $name\n".
				"Телефон: $phone\n".
				"Срок создания сайта - 1 - 3 дня: $services_1\n".
				"Дизайн сайта\n
				Типовой: $services_2\n
				Индивидуальный: $services_02\n".
